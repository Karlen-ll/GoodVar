...
function checkClass(elem, className) {
  return elem.classList.contains
    ...
    : elem.getAttribute('class').indexOf(className) > -1
}
// Add class
...
function PrepareString(str) {
  return RemoveExtraSpaces(str.replace(/<[^>]+>/g, ''))
}
...
function PrepareUrl(url) {
  return RemoveProtocol(url.replace(/[?].*$/, '').replace(/\/$/, ''))
}
...
function PrepareTooltip(elem, word) {
  ...
  if (document.documentElement.lang == 'en-EN') {
    elem.setAttribute(
      'tooltip',
      word ? countWords(elem.textContent) + ' words' : elem.textContent.length + ' characters'
    )
  } else {
...
function CreateMsg(text, className, timeOut) {
  ...
  newMsg.onclick = function () {
    DisplayLayer(this, 'display: none;', false)
  }
  // show message
...
function GetBreadcrumb() {
  ...
  breadcrumb = breadcrumb.filter(function (elem) {
    return elem !== ''
  })
  // Return array
  return breadcrumb
...
// Hide/Show scrollbar
function HideScroll(bool) {
  document.documentElement.style.cssText = bool ? 'overflow: hidden;' : ''
}
...
function setEventByClassName(className, event, func) {
  ...
  for (var i = 0; i < elems.length; i++) {
    ...
    if (event == 'oninput') {
      elems[i].oninput = func
    }
    if (event == 'onchange') {
      elems[i].onchange = func
    }
  }
}
...
/* Popup functions */
// Close popup window
setEventByClassName('app-popup_close', 'onclick', function () {
  popupClose()
})
setEventByClassName('app-popup_ok', 'onclick', function () {
  popupClose()
})
setEventByClassName('app-popup_overlay', 'onclick', function () {
  popupClose()
})
...
setEventByClassName('btn-clear', 'onclick', function () {
  clearInputValue(this)
})
setEventByClassName('btn-clear_white', 'onclick', function () {
  clearInputValue(this)
})
...
function calcLength(input, max) {
  ...
  input.previousElementSibling.children[0].innerHTML =
    length > max ? '<kbd class="text-danger">' + length + '</kbd>' + max : '<kbd>' + length + '</kbd>' + max
}
...
setEventByClassName('input_fields', 'oninput', function () {
  DisabledButton_GetCode()
})
...
setEventByClassName('app-sidebar-item', 'onclick', function () {
...
function GetResults() {
  ...
  if (!MobilePlatform) {
    // Desktop version
    // Yandex
    document.querySelector('.yandex-results .result-title').innerHTML = WrapHtml(
      ShortenStr(final_title, 536, '18px arial')
    )
    ...
    // Google
    document.querySelector('.google-results .result-title').innerHTML = WrapHtml(
      ShortenStr(final_title, 600, '20px arial')
    )
    ...
    document.querySelector('.bing-results .result-title').innerHTML = WrapHtml(
      ShortenStr(final_title, 608, '20px roboto')
    )
    document.querySelector('.bing-results .result-desc').innerHTML = ShortenStr(final_desc, 606 * 2, '14px roboto')
    document.querySelector('.bing-results .result-link').innerHTML = Wrap_Url(
      ShortenLink(final_url, 608, '14px roboto')
    )
  } else {
    // Mobile version
    // Yandex
    document.querySelector('.yandex-results .result-title').innerHTML = WrapHtml(
      ShortenStr(final_title, 333 * 3, '20px arial')
    )
    ...
    final_url = 'https://' + final_url
    document.querySelector('.google-results .result-title').innerHTML = WrapHtml(
      ShortenStr(final_title, 325 * 2, '20px arial')
    )
...
function GetCode() {
  ...
  value +=
    '<li><snap class="tag">&lt;meta</snap> <snap class="attr-name">name</snap>=<snap class="attr-str">"description"</snap> <snap class="attr-name">content</snap>=<snap class="attr-str">"' +
    final_desc +
    '"</snap><snap class="tag">&gt;</snap></li>'
  // assign the result
  ...
  if (breadcrumb.length > 0) {
    ...
    value +=
      '<li><snap class="tag">&lt;script</snap> <snap class="attr-name">type</snap>=<snap class="attr-str">"application/ld+json"</snap><snap class="tag">&gt;</snap></li><li>{</li><li>	<snap class="attr-str">"@context"</snap>: <snap class="attr-str">"https://schema.org"</snap>,</li><li>	<snap class="attr-str">"@type"</snap>: <snap class="attr-str">"BreadcrumbList"</snap>,</li><li>	<snap class="attr-str">"itemListElement"</snap>: ['
    for (i = 0; i < breadcrumb.length; i++) {
      value +=
        '{</li><li>		<snap class="attr-str">"@type"</snap>: <snap class="attr-str">"ListItem"</snap>,</li><li>		<snap class="attr-str">"position"</snap>: <snap class="attr-int">' +
        (i + 1) +
        '</snap>,</li>'
      value +=
        i < breadcrumb.length - 1
          ? '<li>		<snap class="attr-str">"name"</snap>: <snap class="attr-str">"' +
            breadcrumb[i] +
            '"</snap>,</li><li>		<snap class="attr-str">"item"</snap>: <snap class="text-danger">"https://' +
            final_url[i] +
            '"</snap></li><li>	},'
          : '<li>		<snap class="attr-str">"name"</snap>: <snap class="attr-str">"' + breadcrumb[i] + '"</snap></li><li>	}'
    }
    ...
    value +=
      '<li><snap class="tag">&lt;ol</snap> <snap class="attr-name">vocab</snap>=<snap class="attr-str">"https://schema.org/"</snap> <snap class="attr-name">typeof</snap>=<snap class="attr-str">"BreadcrumbList"</snap><snap class="tag">&gt;</snap></li>'
    for (i = 0; i < breadcrumb.length; i++) {
      value +=
        '<li>	<snap class="tag">&lt;li</snap> <snap class="attr-name">property</snap>=<snap class="attr-str">"itemListElement"</snap> <snap class="attr-name">typeof</snap>=<snap class="attr-str">"ListItem"</snap><snap class="tag">&gt;</snap></li>'

      value +=
        i < breadcrumb.length - 1
          ? '<li>		<snap class="tag">&lt;a</snap> <snap class="attr-name">property</snap>=<snap class="attr-str">"item"</snap> <snap class="attr-name">typeof</snap>=<snap class="attr-str">"WebPage"</snap> <snap class="attr-name">href</snap>=<snap class="text-danger">"https://' +
            final_url[i] +
            '"</snap><snap class="tag">&gt;</snap></li><li>			<snap class="tag">&lt;span</snap> <snap class="attr-name">property</snap>=<snap class="attr-str">"name"</snap><snap class="tag">&gt;</snap>' +
            breadcrumb[i] +
            '<snap class="tag">&lt;/snap&gt;</snap><snap class="tag">&lt;/a&gt;</snap></li><li>		<snap class="tag">&lt;meta</snap> <snap class="attr-name">property</snap>=<snap class="attr-str">"position"</snap> <snap class="attr-name">content</snap>=<snap class="attr-str">"' +
            (i + 1) +
            '"</snap><snap class="tag">&gt;</snap></li><li>	<snap class="tag">&lt;/li&gt;</snap></li><li>	›</li>'
          : '<li>		<snap class="tag">&lt;span</snap> <snap class="attr-name">property</snap>=<snap class="attr-str">"name"</snap><snap class="tag">&gt;</snap>' +
            breadcrumb[i] +
            '<snap class="tag">&lt;/snap&gt;</snap></li><li>		<snap class="tag">&lt;meta</snap> <snap class="attr-name">property</snap>=<snap class="attr-str">"position"</snap> <snap class="attr-name">content</snap>=<snap class="attr-str">"' +
            (i + 1) +
            '"</snap><snap class="tag">&gt;</snap></li><li>	<snap class="tag">&lt;/li&gt;</snap></li>'
    }
    ...
    value = '<li><snap class="comment">&lt;!-- Add this code to the &lt;body&gt; element --&gt;</snap></li>'
    value +=
      '<li><snap class="tag">&lt;ol</snap> <snap class="attr-name">itemscope</snap> <snap class="attr-name">itemtype</snap>=<snap class="attr-str">"https://schema.org/BreadcrumbList"</snap><snap class="tag">&gt;</snap></li>'
    for (i = 0; i < breadcrumb.length; i++) {
      value +=
        '<li>	<snap class="tag">&lt;li</snap> <snap class="attr-name">itemprop</snap>=<snap class="attr-str">"itemListElement"</snap> <snap class="attr-name">itemscope</snap> <snap class="attr-name">itemtype</snap>=<snap class="attr-str">"https://schema.org/ListItem"</snap><snap class="tag">&gt;</snap></li>'

      value +=
        i < breadcrumb.length - 1
          ? i == 1
            ? '<li>		<snap class="tag">&lt;a</snap> <snap class="attr-name">itemscope</snap> <snap class="attr-name">itemtype</snap>=<snap class="attr-str">"https://schema.org/WebPage"</snap> <snap class="attr-name">itemprop</snap>=<snap class="attr-str">"item"</snap> <snap class="attr-name">itemid</snap>=<snap class="text-danger">"https://' +
              final_url[i] +
              '"</snap> <snap class="attr-name">href</snap>=<snap class="attr-str">"https://' +
              final_url[i] +
              '"</snap><snap class="tag">&gt;</snap></li><li>			<snap class="tag">&lt;span</snap> <snap class="attr-name">itemprop</snap>=<snap class="attr-str">"name"</snap><snap class="tag">&gt;</snap>' +
              breadcrumb[i] +
              '<snap class="tag">&lt;/snap&gt;</snap><snap class="tag">&lt;/a&gt;</snap></li><li>		<snap class="tag">&lt;meta</snap> <snap class="attr-name">itemprop</snap>=<snap class="attr-str">"position"</snap> <snap class="attr-name">content</snap>=<snap class="attr-str">"' +
              (i + 1) +
              '"</snap><snap class="tag">/&gt;</snap></li><li>	<snap class="tag">&lt;/li&gt;</snap></li><li>	›</li>'
            : '<li>		<snap class="tag">&lt;a</snap> <snap class="attr-name">itemprop</snap>=<snap class="attr-str">"item"</snap> <snap class="attr-name">href</snap>=<snap class="text-danger">"https://' +
              final_url[i] +
              '"</snap><snap class="tag">&gt;</snap></li><li>			<snap class="tag">&lt;span</snap> <snap class="attr-name">itemprop</snap>=<snap class="attr-str">"name"</snap><snap class="tag">&gt;</snap>' +
              breadcrumb[i] +
              '<snap class="tag">&lt;/snap&gt;</snap><snap class="tag">&lt;/a&gt;</snap></li><li>		<snap class="tag">&lt;meta</snap> <snap class="attr-name">itemprop</snap>=<snap class="attr-str">"position"</snap> <snap class="attr-name">content</snap>=<snap class="attr-str">"' +
              (i + 1) +
              '"</snap><snap class="tag">/&gt;</snap></li><li>	<snap class="tag">&lt;/li&gt;</snap></li><li>	›</li>'
          : '<li>		<snap class="tag">&lt;span</snap> <snap class="attr-name">itemprop</snap>=<snap class="attr-str">"name"</snap><snap class="tag">&gt;</snap>' +
            breadcrumb[i] +
            '<snap class="tag">&lt;/snap&gt;</snap><snap class="tag">&lt;/a&gt;</snap></li><li>		<snap class="tag">&lt;meta</snap> <snap class="attr-name">itemprop</snap>=<snap class="attr-str">"position"</snap> <snap class="attr-name">content</snap>=<snap class="attr-str">"' +
            (i + 1) +
            '"</snap><snap class="tag">/&gt;</snap></li><li>	<snap class="tag">&lt;/li&gt;</snap></li>'
